...
@reward
def linear_ortho_velocity(reward_args: RewardArgs) -> torch.Tensor:
    """
...
@reward
def body_motion(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def foot_clearance(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def shank_or_knee_col(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def joint_motion(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def joint_constraint(reward_args: RewardArgs):
...
@reward
def target_smoothness(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def torque(reward_args: RewardArgs) -> torch.Tensor:
...
@reward
def slip(reward_args: RewardArgs) -> torch.Tensor:
