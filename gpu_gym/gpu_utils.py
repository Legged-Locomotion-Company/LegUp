...
def is_vectorized_box_observation(observation: th.Tensor, observation_space: gym.spaces.Box) -> bool:
    """
...
def is_vectorized_discrete_observation(observation: Union[int, th.Tensor], observation_space: gym.spaces.Discrete) -> bool:
    """
...
def is_vectorized_multidiscrete_observation(observation: th.Tensor, observation_space: gym.spaces.MultiDiscrete) -> bool:
    """
...
def is_vectorized_multibinary_observation(observation: th.Tensor, observation_space: gym.spaces.MultiBinary) -> bool:
    """
...
def is_vectorized_dict_observation(observation: th.Tensor, observation_space: gym.spaces.Dict) -> bool:
    """
...
def is_vectorized_observation(observation: Union[int, th.Tensor], observation_space: gym.spaces.Space) -> bool:
    """
...
def safe_mean(arr: Union[th.Tensor, list, deque]) -> th.Tensor:
    """
    ...
    :return:
    """
    return th.nan if len(arr) == 0 else th.mean(arr)
...
def obs_as_tensor(
    obs: Union[th.Tensor, Dict[Union[str, int], th.Tensor]], device: th.device
